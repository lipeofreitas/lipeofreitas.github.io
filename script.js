...
const translations = {
  en: {
    ...
    "contactWidget.label": "Live workflow",
    "contactWidget.title": "Contact Intake Widget for Websites",
    ...
    "contactWidget.focus2": "Serverless intake flow with stored submissions and email notification.",
    "contactWidget.stack1": "GitHub Pages widget, Cloudflare Worker API, and D1 persistence.",
    "contactWidget.stack2": "Resend email notification after storage, with D1 delivery status tracking.",
  ...
  pt: {
    ...
    "contactWidget.label": "Workflow publicado",
    ...
    "contactWidget.focus2": "Fluxo serverless com submissões armazenadas e notificação por email.",
    "contactWidget.stack1": "Widget no GitHub Pages, API em Cloudflare Worker e persistência em D1.",
    "contactWidget.stack2": "Notificação por email via Resend após armazenamento, com status rastreado no D1.",
